				...
				sections = {
					'dashboard': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-VZM1W5ZYTJ', { 'page_path': '/' });
								},
							],
						},
					},
					'content': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-VZM1W5ZYTJ', { 'page_path': '/#content' });
								},
							],
						},
					},
					'directories': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-VZM1W5ZYTJ', { 'page_path': '/#directories' });
								},
							],
						},
					},
					'more': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-VZM1W5ZYTJ', { 'page_path': '/#more' });
								},
							],
						},
					},
			...
			// Initialize.
				...
				// Show initial section.
					...
					// Determine target.
						...
						// Section.
							else if (e = $('#' + (h ? h : 'dashboard') + '-section')) {
